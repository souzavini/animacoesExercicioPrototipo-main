...
const Dia1509 = () => {
    ...
    const gerarGrafico = () => {
        ...
        Animated.parallel([
            Animated.timing(height1, {toValue:valores[0], duration:3000}),
            Animated.timing(height2, {toValue:valores[1], duration:3000}),
            Animated.timing(height3, {toValue:valores[2], duration:3000}),
            Animated.timing(height4, {toValue:valores[3], duration:3000}),
            Animated.timing(height5, {toValue:valores[4], duration:3000})
        ]).start();
        Animated.parallel([
            Animated.timing(opacity1, {toValue:valores[0], duration:4000, delay:3000}),
            Animated.timing(opacity2, {toValue:valores[1], duration:4000, delay:3000}),
            Animated.timing(opacity3, {toValue:valores[2], duration:4000, delay:3000}),
            Animated.timing(opacity4, {toValue:valores[3], duration:4000, delay:3000}),
            Animated.timing(opacity5, {toValue:valores[4], duration:4000, delay:3000})
        ]).start();
    }
